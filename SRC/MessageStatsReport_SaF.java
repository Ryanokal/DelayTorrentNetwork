 ...
 */
public class MessageStatsReport_SaF extends Report implements MessageListener {
    ...
    private static final String SUMMARY_XCHG_PROP = "SprayAndFocus.protoXchg";
	private static final String MSG_COUNT_PROP = "SprayAndFocus.copies";

	/**
	 * Constructor.
	 */
	public MessageStatsReport_SaF() {
		init();
	}
	...
	public void messageDeleted(Message m, DTNHost where, boolean dropped) {
		if (isWarmupID(m.getId())  || m.getProperty(SUMMARY_XCHG_PROP) != null) {
			return;
		}
